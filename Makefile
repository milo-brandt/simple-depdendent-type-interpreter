...
Build/main.o: Source/main.cpp Source/WebInterface/web_interface.hpp 
	@mkdir -p $(@D)
	$(compiler_cmd) -O3 -IDependencies/include -c Source/main.cpp -o Build/main.o

Build/CombinatorComputation/combinator_interface.o: Source/CombinatorComputation/combinator_interface.cpp Source/CombinatorComputation/combinator_interface.hpp Source/Utility/binary_tree.hpp Source/Utility/function.hpp Source/Utility/tags.hpp Source/CombinatorComputation/matching.hpp Source/Utility/labeled_binary_tree.hpp Source/CombinatorComputation/primitives.hpp Source/Format/tree_format.hpp Source/Utility/indirect.hpp 
	@mkdir -p $(@D)
...
Build/CombinatorComputation/primitives.o: Source/CombinatorComputation/primitives.cpp Source/Utility/tags.hpp Source/Utility/binary_tree.hpp Source/CombinatorComputation/primitives.hpp Source/Utility/indirect.hpp 
	@mkdir -p $(@D)
...
Debug/main.o: Source/main.cpp Source/WebInterface/web_interface.hpp 
	@mkdir -p $(@D)
	$(compiler_cmd) -O0 -ggdb -IDependencies/include -c Source/main.cpp -o Debug/main.o

Debug/CombinatorComputation/combinator_interface.o: Source/CombinatorComputation/combinator_interface.cpp Source/CombinatorComputation/combinator_interface.hpp Source/Utility/binary_tree.hpp Source/Utility/function.hpp Source/Utility/tags.hpp Source/CombinatorComputation/matching.hpp Source/Utility/labeled_binary_tree.hpp Source/CombinatorComputation/primitives.hpp Source/Format/tree_format.hpp Source/Utility/indirect.hpp 
	@mkdir -p $(@D)
...
Debug/CombinatorComputation/primitives.o: Source/CombinatorComputation/primitives.cpp Source/Utility/tags.hpp Source/Utility/binary_tree.hpp Source/CombinatorComputation/primitives.hpp Source/Utility/indirect.hpp 
	@mkdir -p $(@D)
