...
Build/program: Build/main.o Build/TypeTheory/type_theory.o Build/Expression/expression_tree.o Build/Expression/evaluation_context_interpreter.o Build/Expression/evaluation_context.o Build/WebInterface/web_interface.o Build/WebInterface/session.o Build/Compiler/resolved_tree.o Build/Compiler/flat_instructions.o 
	$(compiler_cmd)  Build/main.o Build/TypeTheory/type_theory.o Build/Expression/expression_tree.o Build/Expression/evaluation_context_interpreter.o Build/Expression/evaluation_context.o Build/WebInterface/web_interface.o Build/WebInterface/session.o Build/Compiler/resolved_tree.o Build/Compiler/flat_instructions.o  -LDependencies/lib -lhttpserver -Wl,-rpath='$$ORIGIN' -lpthread -O3 -o Build/program

Debug/program: Debug/main.o Debug/TypeTheory/type_theory.o Debug/Expression/expression_tree.o Debug/Expression/evaluation_context_interpreter.o Debug/Expression/evaluation_context.o Debug/WebInterface/web_interface.o Debug/WebInterface/session.o Debug/Compiler/resolved_tree.o Debug/Compiler/flat_instructions.o 
	$(compiler_cmd)  Debug/main.o Debug/TypeTheory/type_theory.o Debug/Expression/expression_tree.o Debug/Expression/evaluation_context_interpreter.o Debug/Expression/evaluation_context.o Debug/WebInterface/web_interface.o Debug/WebInterface/session.o Debug/Compiler/resolved_tree.o Debug/Compiler/flat_instructions.o  -LDependencies/lib -lhttpserver -Wl,-rpath='$$ORIGIN' -lpthread -O0 -ggdb -o Debug/program

Build/test_program: Build/TypeTheory/type_theory.o Build/Expression/expression_tree.o Build/Expression/evaluation_context_interpreter.o Build/Expression/evaluation_context.o Build/Compiler/resolved_tree.o Build/Compiler/flat_instructions.o Build/Tests/combinator_matching.o Build/Tests/expression_parser_tests.o Build/Tests/test_main.o Build/Tests/parser_test.o 
	$(compiler_cmd)  Build/TypeTheory/type_theory.o Build/Expression/expression_tree.o Build/Expression/evaluation_context_interpreter.o Build/Expression/evaluation_context.o Build/Compiler/resolved_tree.o Build/Compiler/flat_instructions.o Build/Tests/combinator_matching.o Build/Tests/expression_parser_tests.o Build/Tests/test_main.o Build/Tests/parser_test.o  -LDependencies/lib -O3 -o Build/test_program

Debug/test_program: Debug/TypeTheory/type_theory.o Debug/Expression/expression_tree.o Debug/Expression/evaluation_context_interpreter.o Debug/Expression/evaluation_context.o Debug/Compiler/resolved_tree.o Debug/Compiler/flat_instructions.o Debug/Tests/combinator_matching.o Debug/Tests/expression_parser_tests.o Debug/Tests/test_main.o Debug/Tests/parser_test.o 
	$(compiler_cmd)  Debug/TypeTheory/type_theory.o Debug/Expression/expression_tree.o Debug/Expression/evaluation_context_interpreter.o Debug/Expression/evaluation_context.o Debug/Compiler/resolved_tree.o Debug/Compiler/flat_instructions.o Debug/Tests/combinator_matching.o Debug/Tests/expression_parser_tests.o Debug/Tests/test_main.o Debug/Tests/parser_test.o  -LDependencies/lib -O0 -ggdb -o Debug/test_program
...
Build/main.o: Source/main.cpp Source/Utility/overloaded.hpp Source/Utility/indirect.hpp Source/Compiler/resolved_tree.hpp Source/Compiler/resolved_tree_explanation.hpp Source/WebInterface/web_interface.hpp Source/Parser/recursive_macros.hpp Source/Utility/tags.hpp Source/Utility/result.hpp Source/ExpressionParser/expression_parser.hpp Source/Compiler/flat_instructions.hpp Source/Compiler/resolved_tree_impl.hpp Source/ExpressionParser/parser_tree.hpp Source/Parser/parser.hpp Source/ExpressionParser/parser_tree_impl.hpp 
	@mkdir -p $(@D)
...
Build/Expression/expression_tree.o: Source/Expression/expression_tree.cpp Source/Expression/expression_tree.hpp Source/Utility/tags.hpp Source/Utility/indirect.hpp Source/Utility/overloaded.hpp Source/Expression/pattern_tree_impl.hpp Source/Expression/expression_tree_impl.hpp 
	@mkdir -p $(@D)
	$(compiler_cmd) -O3 -IDependencies/include -c Source/Expression/expression_tree.cpp -o Build/Expression/expression_tree.o

Build/Expression/evaluation_context_interpreter.o: Source/Expression/evaluation_context_interpreter.cpp Source/Expression/expression_tree.hpp Source/Expression/evaluation_context.hpp Source/Utility/overloaded.hpp Source/Expression/evaluation_context_interpreter.hpp Source/Utility/indirect.hpp Source/Compiler/resolved_tree.hpp Source/Expression/expression_tree_impl.hpp Source/Compiler/flat_instructions.hpp Source/Compiler/resolved_tree_explanation.hpp Source/Expression/pattern_tree_impl.hpp Source/Compiler/resolved_tree_impl.hpp Source/Utility/tags.hpp Source/Utility/result.hpp Source/ExpressionParser/parser_tree.hpp Source/ExpressionParser/parser_tree_impl.hpp 
	@mkdir -p $(@D)
...
Build/Expression/evaluation_context.o: Source/Expression/evaluation_context.cpp Source/Expression/expression_tree.hpp Source/Utility/tags.hpp Source/Expression/evaluation_context.hpp Source/Utility/indirect.hpp Source/Utility/overloaded.hpp Source/Expression/pattern_tree_impl.hpp Source/Expression/expression_tree_impl.hpp 
	@mkdir -p $(@D)
...
Build/Compiler/resolved_tree.o: Source/Compiler/resolved_tree.cpp Source/Utility/indirect.hpp Source/Compiler/resolved_tree_explanation.hpp Source/ExpressionParser/parser_tree.hpp Source/Compiler/resolved_tree_impl.hpp Source/Utility/tags.hpp Source/ExpressionParser/parser_tree_impl.hpp Source/Utility/result.hpp Source/Utility/overloaded.hpp Source/Compiler/resolved_tree.hpp 
	@mkdir -p $(@D)
	$(compiler_cmd) -O3 -IDependencies/include -c Source/Compiler/resolved_tree.cpp -o Build/Compiler/resolved_tree.o

Build/Compiler/flat_instructions.o: Source/Compiler/flat_instructions.cpp Source/Utility/indirect.hpp Source/Compiler/flat_instructions.hpp Source/Compiler/resolved_tree_explanation.hpp Source/ExpressionParser/parser_tree.hpp Source/Compiler/resolved_tree_impl.hpp Source/Utility/tags.hpp Source/ExpressionParser/parser_tree_impl.hpp Source/Utility/result.hpp Source/Utility/overloaded.hpp Source/Compiler/resolved_tree.hpp 
	@mkdir -p $(@D)
	$(compiler_cmd) -O3 -IDependencies/include -c Source/Compiler/flat_instructions.cpp -o Build/Compiler/flat_instructions.o

Build/Tests/combinator_matching.o: Source/Tests/combinator_matching.cpp Source/Expression/expression_tree.hpp Source/Utility/tags.hpp Source/Utility/indirect.hpp Source/Utility/overloaded.hpp Source/Expression/pattern_tree_impl.hpp Source/Expression/expression_tree_impl.hpp 
	@mkdir -p $(@D)
	$(compiler_cmd) -O3 -IDependencies/include -c Source/Tests/combinator_matching.cpp -o Build/Tests/combinator_matching.o

Build/Tests/expression_parser_tests.o: Source/Tests/expression_parser_tests.cpp Source/ExpressionParser/expression_parser.hpp Source/Utility/indirect.hpp Source/ExpressionParser/parser_tree.hpp Source/Parser/recursive_macros.hpp Source/Utility/tags.hpp Source/Utility/overloaded.hpp Source/Parser/parser.hpp Source/ExpressionParser/parser_tree_impl.hpp 
	@mkdir -p $(@D)
...
Debug/Expression/expression_tree.o: Source/Expression/expression_tree.cpp Source/Expression/expression_tree.hpp Source/Utility/tags.hpp Source/Utility/indirect.hpp Source/Utility/overloaded.hpp Source/Expression/pattern_tree_impl.hpp Source/Expression/expression_tree_impl.hpp 
	@mkdir -p $(@D)
	$(compiler_cmd) -O0 -ggdb -IDependencies/include -c Source/Expression/expression_tree.cpp -o Debug/Expression/expression_tree.o

Debug/Expression/evaluation_context_interpreter.o: Source/Expression/evaluation_context_interpreter.cpp Source/Expression/expression_tree.hpp Source/Expression/evaluation_context.hpp Source/Utility/overloaded.hpp Source/Expression/evaluation_context_interpreter.hpp Source/Utility/indirect.hpp Source/Compiler/resolved_tree.hpp Source/Expression/expression_tree_impl.hpp Source/Compiler/flat_instructions.hpp Source/Compiler/resolved_tree_explanation.hpp Source/Expression/pattern_tree_impl.hpp Source/Compiler/resolved_tree_impl.hpp Source/Utility/tags.hpp Source/Utility/result.hpp Source/ExpressionParser/parser_tree.hpp Source/ExpressionParser/parser_tree_impl.hpp 
	@mkdir -p $(@D)
...
Debug/Expression/evaluation_context.o: Source/Expression/evaluation_context.cpp Source/Expression/expression_tree.hpp Source/Utility/tags.hpp Source/Expression/evaluation_context.hpp Source/Utility/indirect.hpp Source/Utility/overloaded.hpp Source/Expression/pattern_tree_impl.hpp Source/Expression/expression_tree_impl.hpp 
	@mkdir -p $(@D)
...
Debug/Tests/combinator_matching.o: Source/Tests/combinator_matching.cpp Source/Expression/expression_tree.hpp Source/Utility/tags.hpp Source/Utility/indirect.hpp Source/Utility/overloaded.hpp Source/Expression/pattern_tree_impl.hpp Source/Expression/expression_tree_impl.hpp 
	@mkdir -p $(@D)
