...
The contents of this file are generated from:
  ...
  Generator: Tools/source_generator.py
*/
...
namespace expression_parser::output{
	...
	struct Axiom;
	struct Let;
	template<class Visitor> concept ExpressionVisitor = requires(Visitor visitor, Apply& apply, Lambda& lambda, Identifier& identifier, Hole& hole, Arrow& arrow, Block& block) {
		...
		typename std::common_type_t<std::invoke_result_t<Visitor&&, Apply&>, std::invoke_result_t<Visitor&&, Lambda&>, std::invoke_result_t<Visitor&&, Identifier&>, std::invoke_result_t<Visitor&&, Hole&>, std::invoke_result_t<Visitor&&, Arrow&>, std::invoke_result_t<Visitor&&, Block&> >;
	};
	template<class Visitor> concept ExpressionConstVisitor = requires(Visitor visitor, Apply const& apply, Lambda const& lambda, Identifier const& identifier, Hole const& hole, Arrow const& arrow, Block const& block) {
		std::forward<Visitor>(visitor)(apply);
		std::forward<Visitor>(visitor)(lambda);
		std::forward<Visitor>(visitor)(identifier);
		std::forward<Visitor>(visitor)(hole);
		std::forward<Visitor>(visitor)(arrow);
		std::forward<Visitor>(visitor)(block);
		typename std::common_type_t<std::invoke_result_t<Visitor&&, Apply const&>, std::invoke_result_t<Visitor&&, Lambda const&>, std::invoke_result_t<Visitor&&, Identifier const&>, std::invoke_result_t<Visitor&&, Hole const&>, std::invoke_result_t<Visitor&&, Arrow const&>, std::invoke_result_t<Visitor&&, Block const&> >;
	};
	template<class Visitor> concept ExpressionMoveVisitor = requires(Visitor visitor, Apply&& apply, Lambda&& lambda, Identifier&& identifier, Hole&& hole, Arrow&& arrow, Block&& block) {
	...
	public:
		...
		template<ExpressionVisitor Visitor> auto visit(Visitor&& visitor) & -> std::common_type_t<std::invoke_result_t<Visitor&&, Apply&>, std::invoke_result_t<Visitor&&, Lambda&>, std::invoke_result_t<Visitor&&, Identifier&>, std::invoke_result_t<Visitor&&, Hole&>, std::invoke_result_t<Visitor&&, Arrow&>, std::invoke_result_t<Visitor&&, Block&> >;
		...
		template<ExpressionMoveVisitor Visitor> auto visit(Visitor&& visitor) && -> std::common_type_t<std::invoke_result_t<Visitor&&, Apply&&>, std::invoke_result_t<Visitor&&, Lambda&&>, std::invoke_result_t<Visitor&&, Identifier&&>, std::invoke_result_t<Visitor&&, Hole&&>, std::invoke_result_t<Visitor&&, Arrow&&>, std::invoke_result_t<Visitor&&, Block&&> >;
	};
	...
	template<ExpressionVisitor Visitor> auto Expression::visit(Visitor&& visitor) & -> std::common_type_t<std::invoke_result_t<Visitor&&, Apply&>, std::invoke_result_t<Visitor&&, Lambda&>, std::invoke_result_t<Visitor&&, Identifier&>, std::invoke_result_t<Visitor&&, Hole&>, std::invoke_result_t<Visitor&&, Arrow&>, std::invoke_result_t<Visitor&&, Block&> > {
...
namespace expression_parser::output::archive_detail{
    struct Detail;
    static constexpr std::uint64_t kind_table[] = {0, 0, 0, 0, 0, 0, 1, 1, 1, 2, 2, 2, 2};
}
namespace expression_parser::output::archive_part{
  template<class Visitor> concept PolymorphicKindVisitor = requires(Visitor visitor, Apply& apply, Lambda& lambda, Identifier& identifier, Hole& hole, Arrow& arrow, Block& block, PatternApply& pattern_apply, PatternIdentifier& pattern_identifier, PatternHole& pattern_hole, Declare& declare, Rule& rule, Axiom& axiom, Let& let) {
		std::forward<Visitor>(visitor)(apply);
		std::forward<Visitor>(visitor)(lambda);
		std::forward<Visitor>(visitor)(identifier);
		std::forward<Visitor>(visitor)(hole);
