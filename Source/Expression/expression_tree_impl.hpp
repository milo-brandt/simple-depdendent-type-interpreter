...
namespace expression::tree{
	...
	struct Arg;
	struct External;
	template<class Visitor> concept ExpressionVisitor = requires(Visitor visitor, Apply& apply, Arg& arg, External& external) {
		std::forward<Visitor>(visitor)(apply);
		std::forward<Visitor>(visitor)(arg);
		std::forward<Visitor>(visitor)(external);
		typename std::common_type_t<std::invoke_result_t<Visitor&&, Apply&>, std::invoke_result_t<Visitor&&, Arg&>, std::invoke_result_t<Visitor&&, External&> >;
	};
	template<class Visitor> concept ExpressionConstVisitor = requires(Visitor visitor, Apply const& apply, Arg const& arg, External const& external) {
		std::forward<Visitor>(visitor)(apply);
		std::forward<Visitor>(visitor)(arg);
		std::forward<Visitor>(visitor)(external);
		typename std::common_type_t<std::invoke_result_t<Visitor&&, Apply const&>, std::invoke_result_t<Visitor&&, Arg const&>, std::invoke_result_t<Visitor&&, External const&> >;
	};
	template<class Visitor> concept ExpressionMoveVisitor = requires(Visitor visitor, Apply&& apply, Arg&& arg, External&& external) {
	...
	public:
		...
		template<ExpressionVisitor Visitor> auto visit(Visitor&& visitor) & -> std::common_type_t<std::invoke_result_t<Visitor&&, Apply&>, std::invoke_result_t<Visitor&&, Arg&>, std::invoke_result_t<Visitor&&, External&> >;
		template<ExpressionConstVisitor Visitor> auto visit(Visitor&& visitor) const& -> std::common_type_t<std::invoke_result_t<Visitor&&, Apply const&>, std::invoke_result_t<Visitor&&, Arg const&>, std::invoke_result_t<Visitor&&, External const&> >;
		template<ExpressionMoveVisitor Visitor> auto visit(Visitor&& visitor) && -> std::common_type_t<std::invoke_result_t<Visitor&&, Apply&&>, std::invoke_result_t<Visitor&&, Arg&&>, std::invoke_result_t<Visitor&&, External&&> >;
	};
	struct Apply {
		Expression lhs;
		Expression rhs;
	...
	template<ExpressionVisitor Visitor> auto Expression::visit(Visitor&& visitor) & -> std::common_type_t<std::invoke_result_t<Visitor&&, Apply&>, std::invoke_result_t<Visitor&&, Arg&>, std::invoke_result_t<Visitor&&, External&> > {
	...
	template<ExpressionConstVisitor Visitor> auto Expression::visit(Visitor&& visitor) const& -> std::common_type_t<std::invoke_result_t<Visitor&&, Apply const&>, std::invoke_result_t<Visitor&&, Arg const&>, std::invoke_result_t<Visitor&&, External const&> > {
		if(!data) std::terminate();
		switch(index) {
	...
	template<ExpressionMoveVisitor Visitor> auto Expression::visit(Visitor&& visitor) && -> std::common_type_t<std::invoke_result_t<Visitor&&, Apply&&>, std::invoke_result_t<Visitor&&, Arg&&>, std::invoke_result_t<Visitor&&, External&&> > {
		if(!data) std::terminate();
		switch(index) {
